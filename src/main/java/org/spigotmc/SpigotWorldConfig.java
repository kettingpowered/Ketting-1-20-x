...
public class SpigotWorldConfig {
    ...
    private List getList(String path, Object def) {
        this.config.addDefault("world-settings.default." + path, def);
    ...
    private void initHunger() {
        if (SpigotConfig.version < 10) {
            ...
            this.set("hunger.combat-exhaustion", 0.1D);
            this.set("hunger.regen-exhaustion", 6.0D);
        }

        this.jumpWalkExhaustion = (float) this.getDouble("hunger.jump-walk-exhaustion", 0.05D);
        this.jumpSprintExhaustion = (float) this.getDouble("hunger.jump-sprint-exhaustion", 0.2D);
        this.combatExhaustion = (float) this.getDouble("hunger.combat-exhaustion", 0.1D);
        this.regenExhaustion = (float) this.getDouble("hunger.regen-exhaustion", 6.0D);
        this.swimMultiplier = (float) this.getDouble("hunger.swim-multiplier", 0.01D);
        this.sprintMultiplier = (float) this.getDouble("hunger.sprint-multiplier", 0.1D);
        this.otherMultiplier = (float) this.getDouble("hunger.other-multiplier", 0.0D);
    }
