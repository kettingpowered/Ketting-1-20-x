...
public class KettingReflectionHandler extends ClassLoader {
    ...
    public static String handlePackageGetName(String name) {
        if (name.startsWith(PREFIX)) {
            return PREFIX + "server." + KettingConstants.BUKKIT_PACKAGE_VERSION;
        } else {
            return name;
        }
    }
    ...
    public static Object[] handleMethodInvoke(Method method, Object src, Object[] param) throws Throwable {
        Object[] ret = KettingRedirectAdapter.runHandle(remapper, method, src, param);
        if (ret != null) {
            return ret;
        } else {
    ...
    public static Object redirectMethodInvoke(Method method, Object src, Object[] param) throws Throwable {
        Object ret = KettingRedirectAdapter.runRedirect(remapper, method, src, param);
        if (ret != remapper) {
            return ret;
        } else {
