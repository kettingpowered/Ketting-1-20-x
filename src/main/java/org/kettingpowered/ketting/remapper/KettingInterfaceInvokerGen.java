...
public class KettingInterfaceInvokerGen implements PluginTransformer {

    public static final KettingInterfaceInvokerGen INSTANCE = new KettingInterfaceInvokerGen();
            ...
            for (Map.Entry<String, String> entry : set) {
                ...
                if (node != null && !node.name.equals(name)) {
                    ...
                    if (!extend) {
                        ...
                        Ketting.LOGGER.debug("Generated {} redirecting to {}", classNode.name + "/" + name + " " + desc, node.owner + "/" + node.name + " " + node.desc);
                    }
                }
            }
        }
