...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    public static BlockState getBlock(Material material, byte data) {
        return org.bukkit.craftbukkit.v1_20_R1.legacy.CraftLegacy.fromLegacyData(org.bukkit.craftbukkit.v1_20_R1.legacy.CraftLegacy.toLegacy(material), data);
    }

    public static MaterialData getMaterial(BlockState data) {
        return org.bukkit.craftbukkit.v1_20_R1.legacy.CraftLegacy.toLegacy(getMaterial(data.getBlock())).getNewData(toLegacyData(data));
    }
    ...
    public static MaterialData getMaterialData(Item item) {
        return org.bukkit.craftbukkit.v1_20_R1.legacy.CraftLegacy.toLegacyData(getMaterial(item));
    }

    // ========================================================================
    public static final Map<Block, Material> BLOCK_MATERIAL = new HashMap<>(); //Ketting - public
    public static final Map<Item, Material> ITEM_MATERIAL = new HashMap<>(); //Ketting - public
    public static final BiMap<net.minecraft.world.level.material.Fluid, Fluid> FLUIDTYPE_FLUID = HashBiMap.create();
    public static final Map<Material, Item> MATERIAL_ITEM = new HashMap<>(); //Ketting - public
    public static final Map<Material, Block> MATERIAL_BLOCK = new HashMap<>(); //Ketting - public
    ...
    public static Item getItem(Material material) {
        if (material != null && material.isLegacy()) {
            material = org.bukkit.craftbukkit.v1_20_R1.legacy.CraftLegacy.fromLegacy(material);
        }
    ...
    public static byte toLegacyData(BlockState data) {
        return org.bukkit.craftbukkit.v1_20_R1.legacy.CraftLegacy.toLegacyData(data);
    }

    @Override
    public Material toLegacy(Material material) {
        return org.bukkit.craftbukkit.v1_20_R1.legacy.CraftLegacy.toLegacy(material);
    }
    ...
    public Material fromLegacy(MaterialData material, boolean itemPriority) {
        return org.bukkit.craftbukkit.v1_20_R1.legacy.CraftLegacy.fromLegacy(material, itemPriority);
    }
    ...
    public String getTranslationKey(EntityType entityType) {
        ...
        return BuiltInRegistries.ENTITY_TYPE.getOptional(CraftNamespacedKey.toMinecraft(entityType.getKey())).map(net.minecraft.world.entity.EntityType::getDescriptionId)
                .orElseGet(()->{
            Bukkit.getLogger().log(Level.WARNING, "Unable to get Translation Key for EntityType. Getting Name instead.", new Throwable());
     ...
     * <p>
     * These should match TagParser#getTypeId
     */
