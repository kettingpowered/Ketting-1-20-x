...
public class CraftFurnaceRecipe extends FurnaceRecipe implements CraftRecipe {
    ...
    public void addToCraftingManager() {
        ...
        MinecraftServer.getServer().getRecipeManager().addRecipe(new RecipeHolder(CraftNamespacedKey.toMinecraft(this.getKey()), new SmeltingRecipe(this.getGroup(), CraftRecipe.getCategory(this.getCategory()), this.toNMS(this.getInputChoice(), true), CraftItemStack.asNMSCopy(result), this.getExperience(), this.getCookingTime())));
    }
}
