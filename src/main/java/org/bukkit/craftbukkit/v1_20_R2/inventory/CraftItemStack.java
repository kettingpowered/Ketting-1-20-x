...
public final class CraftItemStack extends ItemStack {
    ...
    public void addUnsafeEnchantment(Enchantment ench, int level) {
        ...
        if (makeTag(this.handle)) {
            ListTag list = getEnchantmentList(this.handle);

            if (list == null) {
                list = new ListTag();
                this.handle.getTag().put(CraftMetaItem.ENCHANTMENTS.NBT, list);
            }
    ...
    public int getEnchantmentLevel(Enchantment ench) {
        Preconditions.checkArgument(ench != null, "Enchantment cannot be null");
        return this.handle == null ? 0 : EnchantmentHelper.getItemEnchantmentLevel(CraftEnchantment.getRaw(ench), this.handle);
    }
    ...
    public int removeEnchantment(Enchantment ench) {
        ...
        if (list == null) {
            ...
            for (i = 0; i < size; ++i) {
                ...
                if (ench.getKey().equals(NamespacedKey.fromString(id))) {
                    index = i;
                    level = '\uffff' & enchantment.getShort(CraftMetaItem.ENCHANTMENTS_LVL.NBT);
                    break;
                }
            }
            ...
            if (index == Integer.MIN_VALUE) {
                ...
                if (this.handle.getTag().isEmpty()) {
                    this.handle.setTag((CompoundTag) null);
                }
                ...
                this.handle.getTag().put(CraftMetaItem.ENCHANTMENTS.NBT, listCopy);
                return level;
            }
        }
    }
    ...
    static Map getEnchantments(net.minecraft.world.item.ItemStack item) {
        ...
        if (list != null && list.size() != 0) {
            ...
            for (int i = 0; i < list.size(); ++i) {
                ...
                int level = '\uffff' & ((CompoundTag) list.get(i)).getShort(CraftMetaItem.ENCHANTMENTS_LVL.NBT);
    ...
    public static boolean setItemMeta(net.minecraft.world.item.ItemStack item, ItemMeta itemMeta) {
        if (item == null) {
            return false;
        } else if (CraftItemFactory.instance().equals(itemMeta, (ItemMeta) null)) {
    ...
    public boolean isSimilar(ItemStack stack) {
        if (stack == null) {
            ...
            if (this.handle == that.handle) {
                ...
                return comparisonType == this.getType() && this.getDurability() == that.getDurability() ? (this.hasItemMeta() ? that.hasItemMeta() && this.handle.getTag().equals(that.handle.getTag()) : !that.hasItemMeta()) : false;
            } else {
                return false;
            }
        }
    ...
    public boolean hasItemMeta() {
        return hasItemMeta(this.handle) && !CraftItemFactory.instance().equals(this.getItemMeta(), (ItemMeta) null);
    }
    ...
    static int[] $SWITCH_TABLE$org$bukkit$Material() {
        int[] aint = CraftItemStack.$SWITCH_TABLE$org$bukkit$Material;
        ...
        if (aint != null) {
            ...
            CraftItemStack.$SWITCH_TABLE$org$bukkit$Material = aint1;
            return aint1;
        }
    }
}
