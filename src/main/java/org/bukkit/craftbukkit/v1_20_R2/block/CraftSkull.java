...
public class CraftSkull extends CraftBlockEntityState implements Skull {

    private static final int MAX_OWNER_LENGTH = 16;
    private GameProfile profile;
    private static volatile int[] $SWITCH_TABLE$org$bukkit$SkullType;
    ...
    static int[] $SWITCH_TABLE$org$bukkit$SkullType() {
        ...
        if (aint != null) {
            ...
            try {
                aint1[SkullType.DRAGON.ordinal()] = 6;
            } catch (NoSuchFieldError nosuchfielderror1) {
                ;
            }

            try {
                aint1[SkullType.PIGLIN.ordinal()] = 7;
    ...
    static int[] $SWITCH_TABLE$org$bukkit$Material() {
        int[] aint = CraftSkull.$SWITCH_TABLE$org$bukkit$Material;
        ...
        if (aint != null) {
            ...
            CraftSkull.$SWITCH_TABLE$org$bukkit$Material = aint1;
            return aint1;
        }
    }
}
