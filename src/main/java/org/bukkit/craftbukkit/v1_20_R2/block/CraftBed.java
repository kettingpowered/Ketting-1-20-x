...
public class CraftBed extends CraftBlockEntityState implements Bed {
    ...
    static int[] $SWITCH_TABLE$org$bukkit$Material() {
        int[] aint = CraftBed.$SWITCH_TABLE$org$bukkit$Material;
        ...
        if (aint != null) {
            ...
            CraftBed.$SWITCH_TABLE$org$bukkit$Material = aint1;
            return aint1;
        }
    }
}
