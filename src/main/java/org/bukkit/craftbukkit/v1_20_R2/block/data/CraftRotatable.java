...
public abstract class CraftRotatable extends CraftBlockData implements Rotatable {
    ...
    public BlockFace getRotation() {
        int data = (Integer) this.get(CraftRotatable.ROTATION);
    ...
    public void setRotation(BlockFace rotation) {
        ...
        this.set((Property) CraftRotatable.ROTATION, (Comparable) Integer.valueOf(val));
    }

    static int[] $SWITCH_TABLE$org$bukkit$block$BlockFace() {
        int[] aint = CraftRotatable.$SWITCH_TABLE$org$bukkit$block$BlockFace;
        ...
        if (aint != null) {
            ...
            CraftRotatable.$SWITCH_TABLE$org$bukkit$block$BlockFace = aint1;
            return aint1;
        }
    }
}
