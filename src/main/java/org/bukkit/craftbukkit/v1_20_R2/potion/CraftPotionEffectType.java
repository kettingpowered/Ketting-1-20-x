...
public class CraftPotionEffectType extends PotionEffectType {
    ...
    public static PotionEffectType minecraftToBukkit(MobEffect minecraft) {
        ...
        Registry registry = CraftRegistry.getMinecraftRegistry(Registries.MOB_EFFECT);
        PotionEffectType bukkit = PotionEffectType.getByKey(CraftNamespacedKey.fromMinecraft(((ResourceKey) registry.getResourceKey(minecraft).orElseThrow()).location()));
    ...
    public static MobEffect bukkitToMinecraft(PotionEffectType bukkit) {
        Preconditions.checkArgument(bukkit != null);
        return (MobEffect) CraftRegistry.getMinecraftRegistry(Registries.MOB_EFFECT).getOptional(CraftNamespacedKey.toMinecraft(bukkit.getKey())).orElseThrow();
    }
}
