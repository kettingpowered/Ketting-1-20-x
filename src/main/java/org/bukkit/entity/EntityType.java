...
public enum EntityType implements Keyed, Translatable {
    ...
    public static final Map<String, EntityType> NAME_MAP = new HashMap<String, EntityType>(); //Ketting - public
    public static final Map<Short, EntityType> ID_MAP = new HashMap<Short, EntityType>(); //Ketting - public
    ...
    public void createFactory(net.minecraft.world.entity.EntityType<?> value) {
        this.customEntityFactory = (loc) -> {
            ...
            net.minecraft.world.level.Level handle = ((org.bukkit.craftbukkit.v1_20_R3.CraftWorld) loc.getWorld()).getHandle();
