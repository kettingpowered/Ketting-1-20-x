...
public class ForgeLoadingOverlay extends LoadingOverlay {
    public ForgeLoadingOverlay(Minecraft p_96172_, ReloadInstance p_96173_, Consumer<Optional<Throwable>> p_96174_, DisplayWindow window) {
        super(p_96172_, p_96173_, p_96174_, window!=null);
    }
    ...
    public static Supplier<?> newInstance(Supplier<?> s1, Supplier<?> s2, Consumer<?> c, DisplayWindow w){ return ()->null;}
}