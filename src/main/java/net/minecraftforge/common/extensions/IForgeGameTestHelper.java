...
public interface IForgeGameTestHelper {
    ...
    default ServerPlayer makeMockServerPlayer() {
        ...
        new ServerGamePacketListenerImpl(level.getServer(), connection, player, cookie/*, player*/); //Ketting - fix compilation error. IDK if this is the proper fix and IDC. We don't use Forge's TestServer anyway.
        return player;
    }
}
