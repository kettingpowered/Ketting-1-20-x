...
public class BootstrapLauncher {
    ...
    public static void startServer(String[] args) {
        ...
        legacyClasspath.replaceAll(s -> s.startsWith("libraries/") ? s.replace("libraries/", JarTool.getJarDir() + File.separator + KettingConstants.INSTALLER_LIBRARIES_FOLDER + File.separator) : s);
